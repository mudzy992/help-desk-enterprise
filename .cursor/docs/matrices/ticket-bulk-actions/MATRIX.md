...
## API
`POST /tickets/bulk` i `POST /tickets/bulk/preview`. Broadcast iznad `private.guardrails.bulkBroadcast.confirmAboveRecipients` zahtijeva `broadcastConfirmed` (vidi `guardrails-anti-loop-anti-spam`).
