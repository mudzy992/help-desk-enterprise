...
## Cilj
Response i resolution timeri na `TicketSlaState`, vezani na postojeće SLA profile/rules i BH kalendar. Pause/resume je settings-driven. Nije overdue UI niti seed profila.
...
## Namjerno NIJE
Overdue eskalacije, UI badge/filter, seed INCIDENT/ACCESS/… profila.
