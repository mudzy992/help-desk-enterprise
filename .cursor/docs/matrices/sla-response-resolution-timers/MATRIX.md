...
## Cilj
Response i resolution timeri na `TicketSlaState`, vezani na postojeće SLA profile/rules i BH kalendar. Pause/resume je settings-driven. Overdue scan i eskalacije: `sla-breach-escalation`. Nije UI badge/filter.
