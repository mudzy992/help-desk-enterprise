...
- Migracija `20260921120000_group_auto_assign_strategy` (ručno napisana, bez `migrate dev` — vidi HANDOFF): `ALTER TABLE "Group" ADD COLUMN "autoAssignStrategy" "AutoAssignStrategy" NOT NULL DEFAULT 'NONE'`. Primijeniti sa `prisma migrate deploy`.
