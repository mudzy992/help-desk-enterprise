...
- `private.ticket.approvals.enabled` (private, boolean, default `true`)
- `private.ticket.approvals.requiredByServiceJson` (secret, string, bez defaulta, nije required; prazno = `{}`)
- `private.ticket.approvals.defaultApproverRole` (private, `ADMIN` \| `AGENT` \| `SUPER_ADMIN`, default `ADMIN`)
- `private.ticket.approvals.allowRequesterManager` (private, boolean, default `false`)
...
- `private.ticket.confidential.enabled` (private, boolean, default `true`)
- `private.ticket.confidential.defaultForServicesCsv` (private, string, default `""`)
- `private.ticket.confidential.allowedViewerRolesCsv` (private, string, default `""`)
- `private.ticket.confidential.allowedViewerGroupIdsCsv` (private, string, default `""`)
- `private.ticket.confidential.breakGlassEnabled` (private, boolean, default `true`)
- `private.ticket.confidential.breakGlassAllowedRolesCsv` (private, string, default `SUPER_ADMIN`)
- `private.ticket.confidential.breakGlassRequiresReason` (private, boolean, default `true`)
- `private.ticket.confidential.auditViews` (private, boolean, default `true`)
- `private.security.safeLogging.enabled` (private, boolean, default `true`)
- `private.security.safeLogging.levelsCsv` (private, string, default `CONFIDENTIAL,RESTRICTED`)
- `private.security.safeLogging.redactFieldsCsv` (private, string, default `ticket_title,ticket_description,chat_message`)
- `private.guardrails.antiLoop.enabled` (private, boolean, default `true`)
- `private.guardrails.antiLoop.duplicateWindowMinutes` (private, number, default `2`)
- `private.guardrails.antiLoop.similarityThreshold` (private, number, default `0.9`)
- `private.guardrails.antiLoop.mode` (private, `warn_only` \| `soft_block`, default `warn_only`)
- `private.guardrails.bulkBroadcast.confirmAboveRecipients` (private, number, default `200`)
- `private.csat.enabled` (private, boolean, default `true`)
- `private.csat.scaleMax` (private, number, default `5`)
- `private.csat.askOnResolved` (private, boolean, default `true`)
- `private.csat.askOnClosed` (private, boolean, default `false`)
- `private.csat.samplingRate` (private, number, default `1.0`)
- `private.dataLifecycle.archive.enabled` (private, boolean, default `true`)
- `private.dataLifecycle.archive.afterClosedDays` (private, number, default `30`)
- `private.dataLifecycle.archive.archivedReadOnly` (private, boolean, default `true`)
- `private.dataLifecycle.archive.searchable` (private, boolean, default `true`)
