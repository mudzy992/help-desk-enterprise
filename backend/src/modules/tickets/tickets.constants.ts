...
export const ticketChangeLogReasons = {
  ...
  timeManualAdd: 'ticket_time_manual_add',
  timeCorrect: 'ticket_time_correct',
  timeDelete: 'ticket_time_delete',
  ...
  priorityOverride: 'ticket_priority_override',
  merge: 'ticket_merge',
  unmerge: 'ticket_unmerge',
  mergedStatusPropagation: 'ticket_merged_status_propagation',
