...
const availabilityTone: Record<ServiceResponse["availability"], "success" | "warning" | "info"> = {
  OPERATIONAL: "success",
  DEGRADED: "warning",
  MAINTENANCE: "info",
};
...
export function CreateTicketServicePicker({
  ...
  return (
    <div className="p-5">
      <h2 className="text-[14px] font-semibold text-foreground">{t("tickets.pickService")}</h2>
      <p className="mt-0.5 text-[12px] text-muted-foreground">{t("tickets.pickServiceHint")}</p>
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                {selected ? (
                  ...
                  <Badge tone={availabilityTone[service.availability]} dot={false} className="text-[10px]">
              ...
              service.runtimeAvailability.isCurrentlyUnavailable ? (
                <p className="mt-2 text-[11.5px] text-warning">{t("tickets.availabilityUnavailable")}</p>
              ) : null}
